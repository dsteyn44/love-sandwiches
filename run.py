...
def update_worksheet(data, worksheet):
    ...
    Update the relevant worksheet with the data provided - this is called
    """
...
def calculate_surplus_data(sales_row):
    """
    Compare sales with stock to work out surplas

    The surplas is defined as the sales figure subtracted from the stock figure
    ...
    """
    pprint(stock) this is built in function - added to the top shows all rows. Below we access the last row in our surplas data.
...
def main():
    ...
    """ Updating the calls from the update Worksheet above"""
